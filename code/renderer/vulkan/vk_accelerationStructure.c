...
void VK_UpdateBottomSingleDelete(VkCommandBuffer commandBuffer, vkbottomAS_t* bas, VkBuildAccelerationStructureFlagsNV flag) {
...
void VK_UpdateBottomSingle(VkCommandBuffer commandBuffer, vkbottomAS_t* bas) {
