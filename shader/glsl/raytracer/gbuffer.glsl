...
layout(binding = BINDING_OFFSET_GBUFFER_ILLUMINATION, set = 0, rgba16f) uniform image2D IMG_GBUFFER_ILLUMINATION;
...
layout(binding = BINDING_OFFSET_GBUFFER_ILLUMINATION_PREV, set = 0, rgba16f) uniform image2D IMG_GBUFFER_ILLUMINATION_PREV;
